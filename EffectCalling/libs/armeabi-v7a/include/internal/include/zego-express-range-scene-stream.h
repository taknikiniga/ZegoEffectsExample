...
/// @return Error code, please refer to the error codes document https://doc-en.zego.im/en/5548.html for details.
ZEGOEXP_API zego_error EXP_CALL zego_express_range_scene_stream_update_playing_canvas(
    int range_scene_handle, const char *stream_id, struct zego_canvas *canvas);

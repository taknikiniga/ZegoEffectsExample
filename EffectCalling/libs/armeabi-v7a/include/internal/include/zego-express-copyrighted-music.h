...
ZEGOEXP_API zego_seq EXP_CALL
zego_express_copyrighted_music_request_resource(struct zego_copyrighted_music_request_config config,
                                                enum zego_copyrighted_music_resource_type type);
...
/// @param type The resource type of music.
ZEGOEXP_API zego_seq EXP_CALL zego_express_copyrighted_music_get_shared_resource(
...
///
/// @param resource_id the resource ID corresponding to the accompaniment or accompaniment clip.
ZEGOEXP_API int EXP_CALL zego_express_copyrighted_music_get_full_score(const char *resource_id);

...
/// @return The real-time sequential data manager instance index, -1 will be returned when the maximum number is exceeded.
ZEGOEXP_API int EXP_CALL zego_express_create_real_time_sequential_data_manager(const char *room_id);
...
/// @param instance_index The real time sequential data manager instance index.
ZEGOEXP_API zego_seq EXP_CALL zego_express_send_real_time_sequential_data(const unsigned char *data,
...
ZEGOEXP_API zego_seq EXP_CALL zego_express_send_broadcast_message(const char *room_id,
                                                                  const char *message);
...
///   3. If you need to communicate with the Web SDK, please do not use '%'.
/// @param message The content of the message. Required: Yes. Value range: The length does not exceed 1024 bytes.
ZEGOEXP_API zego_seq EXP_CALL zego_express_send_barrage_message(const char *room_id,
                                                                const char *message);
...
ZEGOEXP_API zego_seq EXP_CALL zego_express_send_custom_command(const char *room_id,
                                                               const char *command,

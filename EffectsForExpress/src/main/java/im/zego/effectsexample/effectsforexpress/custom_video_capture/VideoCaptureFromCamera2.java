...
public class VideoCaptureFromCamera2 extends IZegoCustomVideoCaptureHandler implements
    ...
    public VideoCaptureFromCamera2(ZegoExpressEngine express, ZegoEffects zegoEffects, Context context) {
...
//                Matrix.translateM(mPreviewMatrix, 0, ((1.0f - fWidthScale) / 2.0f), ((1.0f - fHeightScale) / 2.0f), 1.0f);
            ...
            if (mIsEffects) {
                ...
                zegoTextureId = zegoEffects.processTexture(mTextureId, zegoEffectsVideoFrameParam);
            }
            ...
            express.sendCustomVideoCaptureTextureData(zegoTextureId, width, height, now);
